...
**Result**: Pending. Both A/B runs have been submitted and are still running as of 2026-03-27, so no outcome is recorded yet.

**Conclusion**: Pending completion of the submitted runs. The decision point after they finish is whether the regularizer moves the new combined-decoder diversity metrics in the desired direction and whether that translates into equal or better final performance relative to the unregularized factorized baseline.
